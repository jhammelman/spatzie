...
plot_motif_pairs_heatmap(-log2(yy1_pd_count_corr$pair_motif_enrich))
```
...
## Count hypergeometric

```{r compute_cosignificance_hyper}
yy1_pd_count_hyper <- anchor_pair_enrich(yy1_pd_interaction,
                                         method = "countHypergeom")
plot_motif_pairs_heatmap(-log2(yy1_pd_count_hyper$pair_motif_enrich))
```
